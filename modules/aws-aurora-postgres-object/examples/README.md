# Aurora PostgreSQL Table Grants Example

This example demonstrates how to configure table-specific grants for the Aurora PostgreSQL audit configuration.
...
module "aurora_postgres_audit_config" {
  ...
  aurora_postgres_cluster_identifier = "my-aurora-postgres-cluster"
  db_host                         = "my-aurora-postgres-cluster.cluster-abcdefg.us-east-1.rds.amazonaws.com"
  db_port                         = 5432
  db_username                     = "admin"
