...
output "mysql_server_fqdn" {
  ...
  value       = module.common_azure-mysql-diagnostic-settings.mysql_server_fqdn
}
...
output "diagnostic_setting_name" {
  ...
  value       = module.common_azure-mysql-diagnostic-settings.diagnostic_setting_name
}

output "diagnostic_setting_id" {
  description = "ID of the diagnostic setting"
  value       = module.common_azure-mysql-diagnostic-settings.diagnostic_setting_id
}