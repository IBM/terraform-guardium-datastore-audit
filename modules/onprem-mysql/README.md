# On-Premises MySQL Configuration
...
module "mysql_audit_linux" {
  source = "IBM/datastore-audit/guardium//modules/onprem-mysql"

  # MySQL Instance Configuration
  mysql_instance_identifier = "On-Premises MySQL"
...
1. `onprem-mysql-registration` - Configures Guardium to receive and process on-premises MySQL syslog audit logs
