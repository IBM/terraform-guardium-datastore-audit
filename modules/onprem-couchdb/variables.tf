...
# CouchDB Instance Variables

variable "couchdb_instance_identifier" {
  type        = string
  description = "Unique identifier for the CouchDB instance"
}

variable "couchdb_host" {
  type        = string
  description = "Hostname or IP address of the CouchDB server"
}

variable "couchdb_audit_log_path" {
  type        = string
  description = "Path to CouchDB audit log file"
...
variable "datasource_tag" {
  type        = string
  description = "Datasource tag for identifying the CouchDB instance in Guardium (required)"
}
...
variable "enable_filebeat_setup" {
  type        = bool
  description = "Enable Filebeat configuration on CouchDB server. Set to false to skip Filebeat setup."
  default     = true
}

variable "server_ip" {
  type        = string
  description = "IP address or hostname of the CouchDB server. Required when enable_filebeat_setup = true."
  default     = ""
}

variable "server_username" {
  type        = string
  description = "Username for SSH connection to the CouchDB server. Required when enable_filebeat_setup = true."
  default     = ""
}

variable "server_password" {
  type        = string
  description = "Password for SSH connection to the CouchDB server. Required when enable_filebeat_setup = true."
  sensitive   = true
  default     = ""
}
