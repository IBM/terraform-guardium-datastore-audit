...
variable "couchbase_admin_username" {
  type        = string
  description = "Couchbase administrator username for REST API access"
}

variable "couchbase_admin_password" {
  type        = string
  description = "Couchbase administrator password for REST API access"
  sensitive   = true
}
...
variable "enable_audit_logging" {
  type        = bool
  description = "Enable Couchbase audit logging via REST API"
  default     = true
}
...
variable "enable_filebeat_setup" {
  type        = bool
  description = "Enable Filebeat configuration on Couchbase server"
  default     = true
}

variable "server_ip" {
  type        = string
  description = "IP address or hostname of the Couchbase server for SSH connection"
}

variable "server_username" {
  type        = string
  description = "Username for SSH connection to the Couchbase server"
}

variable "server_password" {
  type        = string
  description = "Password for SSH connection to the Couchbase server"
  sensitive   = true
}
