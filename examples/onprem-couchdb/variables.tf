...
variable "enable_filebeat_setup" {
  type        = bool
  description = "Enable Filebeat configuration on CouchDB server"
  default     = true
}

variable "server_ip" {
  type        = string
  description = "IP address or hostname of the CouchDB server for SSH connection"
}

variable "server_username" {
  type        = string
  description = "Username for SSH connection to the CouchDB server"
}

variable "server_password" {
  type        = string
  description = "Password for SSH connection to the CouchDB server"
  sensitive   = true
}
